...
from cccat import config
from cccat.error_handler import exception_handler, validation_exception_handler
from cccat.events.event_handlers import EVENT_HANDLERS
from cccat.exceptions import CccatError
from cccat.libs import log_sanitizer
from cccat.views import cat_view, status_view
...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(CccatError, exception_handler)
...
app = FastAPI(
    title="Cccat", description="Lionbridge AI CAT Management Service", version=config.VERSION
)
init_sentry(app)
init_apm(app)
include_routers(app)
