...
@mock.patch("cccat.models.cat_model.create_cat")
@mock.patch("cccat.libs.dates.get_utcnow")
@conftest.async_test
...
@mock.patch("cccat.models.cat_model.find_one")
@conftest.async_test
...
@mock.patch("cccat.models.cat_model.find_many")
@conftest.async_test
